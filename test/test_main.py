...
class TestEmployeeAnalyticsTool(unittest.TestCase):
    def setUp(self):
        ...
        self.sample_data = pd.DataFrame({
            ...
            'Email': ['nva@congty.com', 'ttb@congty.com', 'lvc@congty.com', 'ptd@congty.com'],
            'PhongBan': ['IT', 'HR', 'Ke toan', 'IT'],
            'ChucVu': ['Truong phong', 'Chuyen vien', 'Ke toan truong', 'Nhan vien'],
        ...
        self.sample_data.to_csv(os.path.join(self.input_dir, self.input_file), index=False)
    ...
    def test_runner_with_mock_analytics_engine(self):
        ...
        mock_analytics_engine.calculate_department_stats.return_value = self.sample_data.head(2)
    ...
    def test_runner_output_contains_expected_columns(self):
        ...
        expected_cols = ['SoLuongNhanVien', 'LuongTrungBinh', 'LuongCaoNhat', 'LuongThapNhat']
